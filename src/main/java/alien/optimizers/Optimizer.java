...
public class Optimizer extends Thread {
	...
	private static String[] catalogue_optimizers = { "alien.optimizers.catalogue.LTables", "alien.optimizers.catalogue.GuidTable", "alien.optimizers.catalogue.ResyncLDAP", "alien.optimizers.catalogue.MemoryRecorder",
			...
			"alien.optimizers.priority.PriorityRapidUpdater", "alien.optimizers.priority.PriorityReconciliationService", "alien.optimizers.priority.ActiveUserReconciler", "alien.optimizers.site.SitequeueReconciler"
	};
