...
public class CheckJobStatus extends Optimizer {
    ...
    private void updateFinalJobs(DBFunctions dbdev, Set<Long> masterJobInFinalState, StringBuilder registerLog) {
    ...
    private void updateRunningJobs(DBFunctions dbdev, Set<Long> masterJobInRunningState, StringBuilder registerLog) {
    ...
    private String getUpdateRunningMasterJobsStatusQuery(Set<Long> runningMasterJobs) {
    ...
    private String getUpdateFinalMasterJobsStatusQuery(Set<Long> finalMasterJobs) {
